...
export default function TermineCours(Props) {
  ...
  const updateCours = async () => {
    ...
    const docRef = doc(db, "Users",myclient_uid, "Courses", Props.props.course_uid)
...
//    setOpen(false)
  ...
  return (
    <div>
      ...
      borderColor: 'green' }} onClick={handleOpen}>Terminer le Cours</Button>
      <Modal
        open={open}
        onClose={handleClose}
      ...
      >
        ...
        <Typography id="modal-modal-title" variant="h6" component="h2">
            Etes vous sur de vouloir terminer ce cours  ?
          </Typography>
