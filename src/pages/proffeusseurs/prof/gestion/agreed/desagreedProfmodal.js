...
export default function DesagreedProf(Props) {
  ...
  return (
    <div>
      <Button onClick={handleOpen}>desagreed le Proffeseur</Button>
      <Modal
        open={open}
        onClose={handleClose}
      ...
      >
        <Box sx={style}>
          ...
          <Button onClick={desagreedProf}>desagreed</Button>
        </Box>
      </Modal>
    </div>
  );
