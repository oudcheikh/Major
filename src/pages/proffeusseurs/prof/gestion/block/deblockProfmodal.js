...
export default function DeblockProf(Props) {
  ...
  return (
    <div>
      <Button onClick={handleOpen}>Deblock prof</Button>
      <Modal
        open={open}
        onClose={handleClose}
      ...
      >
        <Box sx={style}>
          <Typography id="modal-modal-title" variant="h6" component="h2">
            Vous voulez deblocker le prof
          </Typography>
          <Typography id="modal-modal-description" sx={{ mt: 2 }}>

          </Typography>
          <Button onClick={deblock}>Deblock</Button>
        </Box>
      </Modal>
    </div>
  );
